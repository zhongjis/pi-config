...
- Herdr agent-graph side-panel presentation lives in [its spec](specs/herdr-agent-graph-presentation.md); it does not redesign transcript tool rows, notifications, or the centered workflow inspector.
