...
- **Version/tag:** `v0.19.0`
- **Immutable ref:** `4f572ea`
- **License:** MIT
- **Adapted:** Panda Harness presentation (tool-rendering, notification-rendering, agent-widget), workflow-without-worktree wiring, thinking-level resolution via shared lib, and root test/discovery wiring.
