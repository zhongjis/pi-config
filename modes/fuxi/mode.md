...
extension_tools: ask,Agent,SubagentWorkflow,get_subagent_result,steer_subagent,Task*,plan_*,look_at,context_*,lsp,codegraph_*,create_goal,get_goal,update_goal,mcporter
extensions: true
