...
model: anthropic/claude-opus-4-6:high,openai-codex/gpt-5.5:high,llama-swap/qwen2.5-coder:14b:high
inherit_context: false
run_in_background: false
builtin_tools: read,write,edit
extension_tools: ask,Agent,get_subagent_result,steer_subagent,TaskCreate,TaskUpdate,TaskList,TaskGet,TaskExecute,lsp_diagnostics,plan_approve,readonly_bash,context_tag,context_log,context_checkout,context_tree_query,context_prune
extensions: clauderock,ask,Agent,get_subagent_result,steer_subagent,TaskCreate,TaskUpdate,TaskList,TaskGet,TaskExecute,lsp_diagnostics,plan_approve,readonly_bash,context_tag,context_log,context_checkout,context_tree_query,context_prune
