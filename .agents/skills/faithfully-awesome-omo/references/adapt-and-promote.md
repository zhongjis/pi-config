# Adapt & promote a persona (archive → adapt → verify)
...
- agents: a single `.md` from the matching generated final prompt. Fu Xi runtime skill: `modes/fuxi/skills/ulw-plan/{SKILL.md,references/*}` adapted from `docs/references/oh-my-openagent/skills/ulw-plan/`.
