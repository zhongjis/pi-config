...
extension_tools: ask,Agent,get_subagent_result,steer_subagent,Task*,plan_approve,plan_scaffold,readonly_bash,look_at,context_*,lsp,codegraph_*,create_goal,get_goal,update_goal
extensions: true
