...
/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:38
 * rationale: preserve the git-repo probe timeout.
 */
export const SUBAGENT_WORKTREE_CHECK_TIMEOUT_MS = 5_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:53
 * rationale: preserve detached worktree creation timeout.
 */
export const SUBAGENT_WORKTREE_CREATE_TIMEOUT_MS = 30_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:81
 * rationale: preserve worktree status timeout.
 */
export const SUBAGENT_WORKTREE_STATUS_TIMEOUT_MS = 10_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:91
 * rationale: preserve git add timeout.
 */
export const SUBAGENT_WORKTREE_ADD_TIMEOUT_MS = 10_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:98
 * rationale: preserve git commit timeout.
 */
export const SUBAGENT_WORKTREE_COMMIT_TIMEOUT_MS = 10_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:108
 * rationale: preserve branch creation timeout.
 */
export const SUBAGENT_WORKTREE_BRANCH_TIMEOUT_MS = 5_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:116
 * rationale: preserve retry branch creation timeout.
 */
export const SUBAGENT_WORKTREE_BRANCH_RETRY_TIMEOUT_MS = 5_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:145
 * rationale: preserve worktree removal timeout.
 */
export const SUBAGENT_WORKTREE_REMOVE_TIMEOUT_MS = 10_000;

/**
 * unit: ms
 * source: extensions/subagent/src/worktree.ts:150
 * rationale: preserve worktree prune timeout.
 */
export const SUBAGENT_WORKTREE_PRUNE_TIMEOUT_MS = 5_000;
