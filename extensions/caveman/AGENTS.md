...
| `test/` | Local-only unit coverage for prompt, state, and Pi lifecycle injection | Upstream tests target other agent runtimes; local behavior needs Pi harness coverage |
