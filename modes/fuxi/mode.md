...
extension_tools: ask,Agent,SubagentWorkflow,agent_graph,get_subagent_result,steer_subagent,Task*,plan_*,look_at,context_*,lsp,codegraph_*,create_goal,get_goal,update_goal,mcporter
extensions: true
