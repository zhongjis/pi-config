...
4. Do not use cat or echo for file creation/editing. Use `apply_patch` for file edits. Keep patches small and match the surrounding lines exactly so verification passes.
