...
| `taishang`, `direnjie`, `juling`, `yunu` | deep consult, gap analysis, complex implementation, UI judgment | `openai-codex/gpt-5.6-sol:high` | These roles depend on trade-off judgment and catching subtle risks. |
