...
extension_tools: ask,Agent,get_subagent_result,steer_subagent,Task*,plan_*,look_at,context_*,lsp,codegraph_*,create_goal,get_goal,update_goal,memory_*,session_search,skill_manage
extensions: true
