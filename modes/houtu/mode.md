...
extension_tools: ask,web_search,code_search,fetch_content,get_search_content,look_at,mcporter,Agent,SubagentWorkflow,agent_graph,get_subagent_result,steer_subagent,Task*,codegraph_*,context_*,process,lsp,interactive_shell
...
- Standalone human-facing documentation and technical prose from supplied or locally verified facts → `cangjie`; behavior-coupled docs → the implementation owner; parent retains architecture/policy decisions and publication.
- All git mutations
</boundaries>
