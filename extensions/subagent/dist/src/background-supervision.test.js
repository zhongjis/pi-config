...
import { BACKGROUND_STALE_ABORT_AFTER_MS, BACKGROUND_STALE_STEER_AFTER_MS, BACKGROUND_SUPERVISION_COOLDOWN_MS, getBackgroundSupervisionAction, getLastProgressAt, } from "./background-supervision.js";
describe("background supervision", () => {
    ...
    it("does nothing for foreground agents", () => {
        expect(getBackgroundSupervisionAction({
