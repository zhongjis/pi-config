...
model: anthropic/claude-opus-4-8:xhigh,github-copilot/claude-opus-5.5:max,cliproxyapi/gpt-6-astra:medium,openai-codex/gpt-6-astra:medium,opencode-go/kimi-k3:max,llama-swap/qwen2.5-coder:14b:high
