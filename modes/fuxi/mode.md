...
model: anthropic/claude-opus-4-8:xhigh,openai-codex/gpt-6-astra:xhigh,opencode-go/deepseek-v4-pro:high,llama-swap/qwen2.5-coder:14b:high
builtin_tools: read,write,edit,bash
extension_tools: ask,Agent,get_subagent_result,steer_subagent,Task*,plan_*,look_at,context_*,lsp,codegraph_*,create_goal,get_goal,update_goal,memory_*,session_search,skill_manage,mcporter
extensions: true
